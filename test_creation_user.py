...
class TestCrearionUser:
    ...
    def test_create_duplicate_courier(self, user_data, delete_user):
    ...
    @allure.title('Нельзя создать пользователя без логина')
    def test_create_user_missing_login(self, user_data):
    ...
    def test_create_user_missing_password(self, user_data):
    ...
    def test_create_user_missing_name(self, user_data):
